...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Story', fields ['title']
        db.delete_unique(u'scrum_story', ['title'])


    def backwards(self, orm):
        # Adding unique constraint on 'Story', fields ['title']
        db.create_unique(u'scrum_story', ['title'])
