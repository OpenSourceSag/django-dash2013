...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'scrum_task', 'status', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'SprintTasks.task_end_status'
        db.alter_column(u'scrum_sprinttasks', 'task_end_status', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Task.status'
        db.alter_column(u'scrum_task', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SprintTasks.task_end_status'
        db.alter_column(u'scrum_sprinttasks', 'task_end_status', self.gf('django.db.models.fields.CharField')(max_length=10))
