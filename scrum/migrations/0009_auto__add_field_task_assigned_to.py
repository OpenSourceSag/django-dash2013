...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'scrum_task', 'assigned_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Task_users', null=True, to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'scrum_task', 'assigned_to_id')
    ...
    models = {
        ...
        u'scrum.story': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stories'", 'to': u"orm['scrum.Project']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'scrum.task': {
            'Meta': {'ordering': "('id',)", 'object_name': 'Task'},
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Task_users'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'estimated_time': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
